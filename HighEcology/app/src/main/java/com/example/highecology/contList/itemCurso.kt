...
@Composable //Padrão de import do Framework Compose
fun CursoItem( // Função dos Itens que vão Dentro do Grupo Completo do Curso
    curso: Curso
) {

    val imagemCurso = curso.imgCurso
    val cursoNome = curso.nomeCurso
    val descricaoCurso = curso.desCurso
    val duracao = curso.dur
